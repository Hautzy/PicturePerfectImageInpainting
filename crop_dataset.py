...
def create_data_loader():
    ...
    val_loader = DataLoader(val_set, shuffle=False, batch_size=val_batch_size, num_workers=16, collate_fn=stack_cropped_pictures)
    train_loader = DataLoader(train_set, shuffle=False, batch_size=train_batch_size, num_workers=16, collate_fn=stack_cropped_pictures)
